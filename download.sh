...
# for debugging
echo "curl -L -O --no-check-certificates hhttps://build.geo-solutions.it/geonode/geoserver/latest/data-${GEOSERVER_VERSION}.zip"
curl -L -O --no-check-certificates https://build.geo-solutions.it/geonode/geoserver/latest/data-$GEOSERVER_VERSION.zip && \
